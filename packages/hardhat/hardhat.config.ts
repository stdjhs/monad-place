...
export default defineConfig({
    ...
    compilers: [
      {
        ...
        settings: {
          ...
          // Monad 官方要求：Sourcify 验证必需 ipfs 元数据哈希
  ...
  // Monad 官方 Hardhat 3 验证配置（Sourcify@BlockVision + Monadscan/Etherscan v2）
  // https://docs.monad.xyz/guides/verify-smart-contract/hardhat
  verify: {
    etherscan: {
  ...
  // Monad 测试网(10143)/主网(143) 的浏览器与 Etherscan v2 API 描述
  chainDescriptors: {
    10143: {
      name: "MonadTestnet",
      blockExplorers: {
  ...
  networks: {
    ...
    // Monad 测试网（ChainID 10143）：`yarn deploy --network monadTestnet`
